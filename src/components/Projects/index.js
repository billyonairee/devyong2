    ...
    <div className="body">
      ...
      <div className="projects-container">
        <Card onClick={devYong2HandleShow}>
          <div className="img-box"><Card.Img variant="top" src="devyong2/DevYong2/DevYong2_1.png" /></div>
          <Card.Body>
        ...
        <Card onClick={snsAppHandleShow}>
          <div className="img-box"><Card.Img variant="top" src="devyong2/SNSApp/SNSApp_1.png" /></div>
          <Card.Body>
        ...
        <Card onClick={nodebirdHandleShow}>
          <div className="img-box"><Card.Img variant="top" src="devyong2/Nodebird/Nodebird_1.png" /></div>
          <Card.Body>
        ...
        <Card onClick={nbbangAppHandleShow}>
          <div className="img-box"><Card.Img variant="top" src="devyong2/NbbangApp/Nbbang-app_1.png" /></div>
          <Card.Body>
        ...
        <Card onClick={nbbangAdminHandleShow}>
          <div className="img-box"><Card.Img variant="top" src="devyong2/NbbangAdmin/Nbbang-admin_1.png" /></div>
          <Card.Body>
        ...
        <Card onClick={class101HandleShow}>
          <div className="img-box"><Card.Img variant="top" src="devyong2/Class101/Class101_1.png" /></div>
          <Card.Body>
            <Card.Title>Business App</Card.Title>
        ...
        <Card onClick={mmReqHandleShow}>
          <div className="img-box"><Card.Img variant="top" src="devyong2/MMReq/MMReq_1.png" /></div>
          <Card.Body>
